...
class ComplexTypeClass extends AClass {
    ...
    ComplexTypeClass(ComplexType ct, Definitions definitions, ApexTypeMapper typeMapper) throws CalloutException, ConnectionException {
        ...
        if (sequence != null) {
            ...
            while (elements.hasNext()) {
                ...
                fields.add(new AField("private", "String[]",
                        name + CalloutConstants.TYPE_INFO_PREFIX, typeInfo(element)));
            }
        }
        ...
        while(attributesIt.hasNext()) {
            ...
            fields.add(new AField("private", "String[]",
                                  name + CalloutConstants.ATTRIBUTE_INFO_PREFIX, attributeInfo(attribute)));
        }
    ...
    private String typeInfo(Element element) {
        String elemNs = element.getRef() == null?
                element.getSchema().getTargetNamespace() : element.getRef().getNamespaceURI();
