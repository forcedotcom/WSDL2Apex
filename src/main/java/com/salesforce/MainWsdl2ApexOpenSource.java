...
public class MainWsdl2ApexOpenSource {
	...
	public static void main(String[] args) throws JUnitTestException{
		if(args.length != 3)
		...
		catch(FileNotFoundException e)
		{
			...
			throw new JUnitTestException("Cannot find the file");
		}
		try
		{
			...
			if(!result.isSuccess())
			{
				...
				throw new JUnitTestException("Failed to parse wsdl");
			}
		}
		catch (Exception e)
		{
			System.err.println(e.getMessage());
			throw new JUnitTestException(e.getMessage());
		}
		...
		catch(CalloutException e)
		{
			...
			throw new JUnitTestException("Failed to generate code");
		}
		catch(Exception e)
		{
			System.err.println(e.getMessage());
