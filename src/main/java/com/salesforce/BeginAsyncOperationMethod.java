...
class BeginAsyncOperationMethod extends OperationMethod {
    ...
    BeginAsyncOperationMethod(Definitions definitions, ApexTypeMapper typeMapper, Operation operation, Binding binding) throws ConnectionException, CalloutException {
    ...
    /** @return the return type without the Future wrapper, e.g. the apex mapped version of the WSDL type, possibly unwrapped */
